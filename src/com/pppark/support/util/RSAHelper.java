...
/**
 * RSA加密解密算法,使用方法按test()来就可以 重要：由于此类内部实现全部为static，所以使用此类前请务必调用init函数执行初始化，以防止相互干扰。
...
public class RSAHelper {
    ...
    /**
     * 初始化algorithm和transformation，如果某个参数为空，则用默认值 重要：请务必在使用此类前调用此方法
     * 
     * @param algorithm
     *            默认"RSA"
     * @param transformation
     *            默认"RSA/ECB/NoPadding"
     */
     ...
     *            即n
     * @param mRadix
     *            modulus的进制，如果为16进制，则填16
     * @param publicExponent
     *            即e
     * @param eRadix
     *            publicExponent的进制，如果为16进制，则填16
     * @return
     * @throws Exception
     */
     ...
     *            即d
     * @param pRadix
     *            privateExponent的进制，如果为16进制，则填16
     * @return
     * @throws Exception
     */
